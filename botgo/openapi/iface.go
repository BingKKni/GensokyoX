...
// FileUploadAPI 大文件分片上传接口
type FileUploadAPI interface {
	GroupUploadPrepare(ctx context.Context, groupID string, req *dto.UploadPrepareRequest) (*dto.UploadPrepareResponse, error)
	GroupUploadPartFinish(ctx context.Context, groupID string, req *dto.UploadPartFinishRequest) (*dto.UploadPartFinishResponse, error)
	GroupPostFile(ctx context.Context, groupID string, req *dto.PostFileRequest) (*dto.MediaResponse, error)
	C2CUploadPrepare(ctx context.Context, userID string, req *dto.UploadPrepareRequest) (*dto.UploadPrepareResponse, error)
	C2CUploadPartFinish(ctx context.Context, userID string, req *dto.UploadPartFinishRequest) (*dto.UploadPartFinishResponse, error)
	C2CPostFile(ctx context.Context, userID string, req *dto.PostFileRequest) (*dto.MediaResponse, error)
}
